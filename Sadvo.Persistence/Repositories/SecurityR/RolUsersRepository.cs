...
{
    public class RolUsersRepository : BaseRepository<RolUsers>, IRolUsersRepository
    {
        private readonly AppElectionsContext _context;
        private readonly ILogger<RolUsersRepository> _logger;

        public RolUsersRepository(AppElectionsContext context, ILogger<RolUsersRepository> logger) : base(context)
        {
            _context = context;
            _logger = logger;
        }

        public override async Task<OperationResult> DeleteEntityAsync(RolUsers entity)
        {
        ...
        public override async Task<OperationResult> SaveEntityAsync(RolUsers entity)
        {
            return await base.SaveEntityAsync(entity);
        }
        public override async Task<RolUsers> GetEntityByIDAsync(int id)
        {
            try
            {
        ...
        public override async Task<OperationResult> UpdateEntityAsync(RolUsers entity)
        {
